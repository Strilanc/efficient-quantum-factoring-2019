\documentclass[a4paper, onecolumn, accepted=2021-03-29]{quantumarticle}
\pdfoutput=1
...
% NatBib as per the Quantum Journal recommendations.
\usepackage[numbers,sort&compress]{natbib}
\bibliographystyle{abbrvnamed}

% Change to \sffamily for other headers.
\newcommand{\tableheadingfont}{}

% Color.
\usepackage{color}

% Color references and anchors.
...
estimate at $n=2048$
    ...
    &(megaqubitdays)
        \\
\hline
Van Meter et al. 2009 \cite{van2010distributed}
    &0.2\%
    &49
    &N/A
    &planar
    &1000+ T and S
    &distillation limited carry lookahead
    &6500
    &410
    &2600000
        \\
Jones et al. 2010 \cite{jones2012layered}
    &0.1\%
    &0.25
    &N/A
    &planar
...
(ours) 2019 (1 factory)
    ...
    &planar
    &1 CCZ
    &distillation limited ripple carry
    &16
    &6
    &90
        \\
...
\textbf{(ours) 2019 (parallel)}
    ...
    &\textbf{planar}
    &\textbf{28 CCZ}
    &\textbf{reaction limited carry runways}
    &\textbf{20}
    &\textbf{0.31}
    &\textbf{5.9}
        \\
  ...
  \caption{
    ...
    We caution the reader to carefully consider the physical assumptions of each paper when comparing their expected volumes.
    For example, assuming a cycle time that is 5x more optimistic will reduce the expected volume by a corresponding factor of 5.
...
For the full details of how to add, maintain, and remove oblivious runways we refer the reader to \cite{gidney2019approximatepermutation}.
That being said, we will point out one optimization not mentioned in that paper which applies here.
Note that, ultimately, each register we add carry runways to is going to either be measured or discarded.
The last thing that would happen to these registers, before they were measured or discarded, is carry runway removal.
However, the carry runway removal process is classical; it can be constructed out of Toffoli gates.
As a result, the carry runway removal process does not need to be performed under superposition.
The register qubits and runway qubits can simply be measured just before the runways would have been removed, and the runway removal process can be performed by classical post-processing of the measurements.
...
\begin{figure}[ht]
    ...
    \resizebox{0.65 \linewidth}{!}{
        \includegraphics{assets/lattice-qubits.pdf}
    }
    \end{center}
    % StabilizerConfigurationDiagram(r"""
    %                 X               X       X               X       X       X       X       X
    %               / \             / \     / \             / \     / \     / \     / \     / \
    %           o   o   o       o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o
    %          / \ / \ /       / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /
    %         Z   X   Z       Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z
    %          \ / \ / \       \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \
    %           o   o   o       o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o
    %           \ / \ / \       \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \
    %             Z   X   Z       Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z
    ...
    %           o   o   o       o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o
    %           \ /           / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /
    %             X           Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z
    %                          \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \
    ...
    %           o   o   o       o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o
    %          / \ / \ /         \ /     \ /           / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /
    %         Z   X   Z           X       X           Z   X   Z   X   Z   X   Z   X   Z   X   Z
    %          \ / \ / \                               \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \
...
\multicolumn{6}{c}{} &
&
\multicolumn{2}{c|}{\tableheadingfont Volume} &
\tableheadingfont Qubits &
\multicolumn{1}{c}{\tableheadingfont Runtime}
\\
\multicolumn{2}{c||}{} & % n and \lenexp
\multicolumn{6}{c||}{\tableheadingfont Parameters} &
\tableheadingfont Retry &
\multicolumn{2}{c|}{\tableheadingfont (megaqubitdays)} &
\tableheadingfont (megaqubits) &
\multicolumn{1}{c}{\tableheadingfont (hours)}
\\
$n$ &
$\lenexp$ &
$\distone$ &
...
$\gexp$ &
$\gsep$ &
\tableheadingfont Risk &
\tableheadingfont per run & \tableheadingfont expected &
\tableheadingfont per run &
\tableheadingfont per run
\\
\cline{1-13}
...
\\
\cline{1-18}
\multirow{7}{*}[0pt]{\rotatebox{90}{\tableheadingfont Schnorr}} &
...
\cline{1-18}
\multirow{14}{*}[0pt]{\rotatebox{90}{\tableheadingfont Safe-prime}} &
\multirow{7}{*}[0pt]{\rotatebox{90}{\tableheadingfont Short}} &
...
& & $16384$   &    & & & $272$  &$17$      &$31$      &$5$       &$4$       &$5$       &$1024$    &$17\%$    &$210$     &$250$     &$220$     &$23$  \\
\cline{2-18}
& \multirow{7}{*}[0pt]{\rotatebox{90}{\tableheadingfont Full Length}} &
...
\cline{1-17}
\multirow{7}{*}[0pt]{\rotatebox{90}{\tableheadingfont Safe-prime}} &
...
\begin{figure}
    \resizebox{1.0 \linewidth}{!}{
        \includegraphics{assets/qubit-houses.pdf}
    }
    %     StabilizerConfigurationDiagram(r"""
    ...
    %          \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ /
    %           X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X
    %          / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \
    %         o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o
    %          \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ /
    %           Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z
    %          / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \
    %         o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o
    %          \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ /
    %           X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z       Z   X   Z   X   Z   X   Z   X
    ...
    %          \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ @ \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /
    %           Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z
    %          / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / @ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \
    %         o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o
    %          \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / @ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /
    %           X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X
    %          / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ @ \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \
    %         o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o
    %          \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ @ \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /
    %           Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X   Z
    ...
    %         o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o   o
    %          \ / \ / \ / \ / \ / \ / \ / \ /     \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /     \ / \ / \ / \ / \ / \ / \ @ \ / \ / \ / \ / \ / \ /     \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /     \ / \ /
    %           Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z
    %          / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / @ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \
    %         o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o
    %          \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / @ / \ / \ / \ / \ / \ / \       \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \       \ /
    %           X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X
    %          / \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /     # / \ # # / \ # # / \ # # @ \ # # / \ # # / \ # # /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \
    %         o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o   o   o   o   o   o   o   o   o   o   o   o       o   o
    %          \ / \ / \ / \ / \ / \ / \ / \ /       / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / # # \ / # # \ / # # \ @ # # \ / # # \ / # # \ / #     / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ / \ /       / \ /
    %           Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z   X   Z   X   Z   X   Z   X   Z   X   Z   X       X   Z
